...
// TODO:
    ...
    //String[] projection1 = {"_id","name","color","parent"};
...
//                projection[2] = "color";
//                projection[3] = "parent";
//                projection[4] = "avg_duration";
//                projection[5] = "start_of_last";
                int n;
                ...
                n = 0;
                boolean parentColumnIncluded = false;
                ...
                while(n < projection.length){
                    ...
                    if(ActivityDiaryContract.DiaryActivity.PARENT.equals(projection[n])){
                        parentColumnIncluded = true;
                        break;
                    }

                    if (!parentColumnIncluded) {
                        String[] newProjection = new String[projection.length + 1];
                        System.arraycopy(projection, 0, newProjection, 0, projection.length);
                        newProjection[projection.length] = ActivityDiaryContract.DiaryActivity.PARENT;
            ...
            case diary_stats:
                ...
                sql = "SELECT " + ActivityDiaryContract.DiaryActivity.TABLE_NAME + "." + ActivityDiaryContract.DiaryActivity.NAME + " as " + ActivityDiaryContract.DiaryStats.NAME
                        ...
                        + ", " + ActivityDiaryContract.DiaryActivity.TABLE_NAME + "." + ActivityDiaryContract.DiaryActivity.PARENT + " as " + ActivityDiaryContract.DiaryStats.PARENT
