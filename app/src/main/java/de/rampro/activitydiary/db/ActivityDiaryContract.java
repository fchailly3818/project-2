...
public class ActivityDiaryContract {
    ...
    public final static class DiaryStats {
        ...
        public static final String[] PROJECTION_ALL =
                {NAME, COLOR, DURATION, PORTION, PARENT};
    ...
    public final static class DiarySearchSuggestion {
        ...
        public interface EventType{
            public static final Integer EVENT_LIFE = 1;
            public static final Integer EVENT_WORK = 2;
            public static final Integer EVENT_SPORT = 3;
            public static final Integer EVENT_RELAX = 4;
        }
