...
public class LocalDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " +
                ...
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Gardening', '" + Color.parseColor("#388e3c") + "', '1');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Woodworking', '" + Color.parseColor("#5d4037") + "', '2');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Officework', '" + Color.parseColor("#00796b") + "', '2');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Swimming', '" + Color.parseColor("#0288d1") + "', '3');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Relaxing', '" + Color.parseColor("#fbc02d") + "', '4');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Cooking', '" + Color.parseColor("#e64a19") + "', '1');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Cleaning', '" + Color.parseColor("#CFD8DC") + "', '1');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Cinema', '" + Color.parseColor("#c2185b") + "', '4');");
        db.execSQL("INSERT INTO " +
                ActivityDiaryContract.DiaryActivity.TABLE_NAME +
                "(" + ActivityDiaryContract.DiaryActivity.NAME + "," + ActivityDiaryContract.DiaryActivity.COLOR + "," + ActivityDiaryContract.DiaryActivity.PARENT + ")" +
                " VALUES " +
                " ('Sleeping', '" + Color.parseColor("#303f9f") + "', '1');");
    }
