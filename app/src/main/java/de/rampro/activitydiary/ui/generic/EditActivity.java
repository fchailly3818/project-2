...
public class EditActivity extends BaseActivity implements ActivityHelper.DataChangedListener {
    ...
    //private TextInputLayout mActivityTypeTIL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityType = (Spinner) contentView.findViewById(R.id.edit_activity_type);
        ...
        //mActivityTypeTIL = (TextInputLayout) findViewById(R.id.edit_activity_type_til);
            ...
            case R.id.action_edit_done:
                if(getCheckState() != CHECK_STATE_CHECKING) {
                    ...
                    if (getCheckState() == CHECK_STATE_ERROR) {
                        ...
                        if (currentActivity == null) {
                            ActivityHelper.helper.insertActivity(new DiaryActivity(-1, mActivityName.getText().toString(), mActivityColor, checkActivityType(mActivityType.getSelectedItem().toString())));
                        } else {
                            currentActivity.setName(mActivityName.getText().toString());
                            currentActivity.setColor(mActivityColor);
                            currentActivity.setMtype(checkActivityType(mActivityType.getSelectedItem().toString()));
    ...
    private int checkActivityType(String s){
        if(Objects.equals(s, "生活")) return 1;
        else if(Objects.equals(s, "工作")) return 2;
        else if(Objects.equals(s, "健康")) return 3;
        else if(Objects.equals(s, "娱乐")) return 4;
        else return 0;
    }
